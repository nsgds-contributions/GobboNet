...
:: The program-scoped allow rule setup-lan.bat adds for gobbonet.exe. It has to
:: come out here too, or an uninstall leaves a firewall rule naming a path that
:: no longer exists -- which is the same class of orphan as the URL reservation
:: this script was written to clear.
